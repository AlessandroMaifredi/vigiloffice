...
#define MQTT_CLIENTID "nodoMaster-**MAC**"                 // client identifier
#define MQTT_USERNAME "QazimToska"         // mqtt user's name
#define MQTT_PASSWORD "iot847361"         // mqtt user's password
#define INFLUXDB_URL "http://149.132.178.179:8086"   // IP and port of the InfluxDB server
