...
--
-- Class Parking as table parkings
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('vigiloffice', '20240611085053457', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20240611085053457', "timestamp" = now();
