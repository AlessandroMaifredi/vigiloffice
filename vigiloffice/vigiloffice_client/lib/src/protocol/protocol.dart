...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i4.DeviceType) {
      return _i4.DeviceType.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i4.DeviceType?>()) {
      return (data != null ? _i4.DeviceType.fromJson(data) : null) as T;
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (data['className'] == 'DeviceType') {
      return deserialize<_i4.DeviceType>(data['data']);
    }
